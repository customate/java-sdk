...
/**
 * Models a schedule (used on creation).
 *
 * Date: 05-Mar-21
 * Time: 3:52 PM
 *
...
public class ScheduleCreate extends BaseModel {
     ...
     * @param currency  ISO 3-digit currency code.
     ...
     */
    public ScheduleCreate(String title, Currency currency, SchedulePurpose schedulePurpose, SchedulePeriod schedulePeriod,
